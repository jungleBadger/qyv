...
class DetectObjectsFromFrames:
    ...
    def process_frame(self, frame: str):
        ...
        detections = results.pandas().xyxy[0].to_dict(orient="records")  # Convert detections to list of dictionaries
        return detections
    ...
    def save_detections(self, frame: str, detections: list):
        ...
        json_path = os.path.join(self.output_dir, f"{os.path.splitext(frame)[0]}_detections.json")
