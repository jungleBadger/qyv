...
app.get('/app', (request, reply) => {
  reply.sendFile('index.html', path.join(__dirname, '../ui/client/user_module/dist')); // serving the index.html from user_module/dist
});

// Serve the index.html file
app.get('/admin', (request, reply) => {
  reply.sendFile('index.html', path.join(__dirname, '../ui/client/admin_module/dist')); // serving the index.html from admin_module/dist
});
